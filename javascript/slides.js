...
var PERMANENT_JAVASCRIPT_URL_PREFIX = './javascript/';
var PERMANENT_CSS_URL_PREFIX = './css/';
...
function addPrettify() {
  ...
  el.src = PERMANENT_JAVASCRIPT_URL_PREFIX + 'prettify.js';
  el.onload = function() {
    prettyPrint();
  }
...
function addGeneralStyle() {
  ...
  el.rel = 'stylesheet';
  el.type = 'text/css';
  el.href = PERMANENT_CSS_URL_PREFIX + 'styles.css';
  document.body.appendChild(el);
